...
export default function DocsPage() {
  ...
  return (
    <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            {SECTIONS.map((s) => (
              <button key={s.id} onClick={() => scrollTo(s.id)} style={{
                ...
                fontSize: 15, padding: "12px 16px", cursor: "pointer",
      ...
      <div style={{
        maxWidth: 1100,
        margin: "0 auto",
        padding: "clamp(20px, 4vw, 40px) clamp(16px, 3vw, 20px) 120px",
          ...
          <main style={{ minWidth: 0, width: "100%", boxSizing: "border-box" }}>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <div style={{ marginBottom: 48 }}>
                ...
                <h1 style={{ fontSize: "clamp(28px, 8vw, 48px)", fontWeight: 300, lineHeight: 1.15, margin: "0 0 14px", wordBreak: "break-word" }}>
                  Documentation
                </h1>
                <Body>
              ...
              <section id="overview" style={{ marginBottom: 48 }}>
                ...
                <Body>VERIS performs trust due diligence on Web3 projects and AI agents, returning a structured trust report inside a JSON envelope. The same endpoint powers the live website and CROO order fulfillment.</Body>
                <TableWrap>
              ...
              <section id="audit" style={{ marginBottom: 48 }}>
                ...
                <p style={{ fontSize: "clamp(12px, 2vw, 13px)", fontWeight: 600, color: "#F5F7FA", margin: "20px 0 2px" }}>Project request</p>
                <CodeBlock code={`{
  "requirements": {
    "type": "project",
    "name": "Aave",
    ...
    "mode": "full"
                ...
                <p style={{ fontSize: "clamp(12px, 2vw, 13px)", fontWeight: 600, color: "#F5F7FA", margin: "20px 0 2px" }}>Agent request</p>
                <CodeBlock code={`{
  "requirements": {
    "type": "agent",
    ...
    "mode": "full"
                ...
                <p style={{ fontSize: "clamp(12px, 2vw, 13px)", fontWeight: 600, color: "#F5F7FA", margin: "20px 0 2px" }}>Response</p>
                <CodeBlock code={`{ "report": "VERIS TRUST REPORT\\n══...\\n(full text)" }`} />

                <p style={{ fontSize: "clamp(12px, 2vw, 13px)", fontWeight: 600, color: "#F5F7FA", margin: "20px 0 4px" }}>Request fields</p>
                <TableWrap>
  ...
  "website": "https://uniswap.org"
                ...
                <p style={{ color: "#8B96A7", fontSize: "clamp(12px, 2vw, 13px)", lineHeight: 1.65, margin: "14px 0 0", wordBreak: "break-word" }}>
