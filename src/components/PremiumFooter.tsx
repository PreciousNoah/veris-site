...
function GlowIcon({ children, href = "#" }: { children: React.ReactNode; href?: string }) {
  return (
    <a
      href={href}
...
function XIcon() {
  return <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.912-5.622Zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>;
}
function GithubIcon() {
        ...
        <div className="veris-footer-inner">
          <div className="veris-footer-grid">
            ...
            <div>
              ...
              <p style={{ fontSize: 14, color: "#8B96A7", lineHeight: 1.7, maxWidth: 280, margin: 0 }}>
                Trust infrastructure for the agent economy. VERIS verifies projects, agents, teams, and digital entities using evidence-based intelligence.
              </p>
            </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {links.map(({ label, href }) => (
                    href.startsWith("/") ? (
                      <Link
                        key={label} href={href}
                        style={{ fontSize: 14, color: "rgba(245,247,250,0.55)", textDecoration: "none", transition: "color 0.2s", letterSpacing: "0.02em" }}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <GlowIcon><XIcon /></GlowIcon>
              <GlowIcon><GithubIcon /></GlowIcon>
              <GlowIcon><DiscordIcon /></GlowIcon>
              <GlowIcon><TelegramIcon /></GlowIcon>
            </div>
          </div>
        </div>
      </div>
